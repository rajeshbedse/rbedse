...
def scan_stock_detail(date_str,symbol):
    ...
    if full_df is not None and not full_df.empty and "Symbol" in full_df.columns:
        ...
        if not full_matches.empty:
            ...
            for field in ["ReportedBuyTxn","PricedValuePurchased","MissingValueQty","MissingValueTxn","MarketBuyValue","MarketSellValue","NetBuyValue","SellBuyRatioPct","HasMarketSell","SellBuyExclusion"]:
